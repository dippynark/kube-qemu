...
// New creates an instance of hypervisor admission plugins initializer.
...
func (i pluginInitializer) Initialize(plugin admission.Interface) {
	if wants, ok := plugin.(WantsInternalHypervisorInformerFactory); ok {
		wants.SetInternalHypervisorInformerFactory(i.informers)
	}
}
