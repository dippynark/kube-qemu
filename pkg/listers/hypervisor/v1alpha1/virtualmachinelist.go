...
type VirtualMachineListLister interface {
	...
	List(selector labels.Selector) (ret []*v1alpha1.VirtualMachineList, err error)
...
// List lists all VirtualMachineLists in the indexer.
func (s *virtualMachineListLister) List(selector labels.Selector) (ret []*v1alpha1.VirtualMachineList, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1alpha1.VirtualMachineList))
	})
	return ret, err
}
...
type VirtualMachineListNamespaceLister interface {
	...
	Get(name string) (*v1alpha1.VirtualMachineList, error)
...
// List lists all VirtualMachineLists in the indexer for a given namespace.
func (s virtualMachineListNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.VirtualMachineList, err error) {
...
// Get retrieves the VirtualMachineList from the indexer for a given namespace and name.
func (s virtualMachineListNamespaceLister) Get(name string) (*v1alpha1.VirtualMachineList, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("virtualmachinelist"), name)
	}
	return obj.(*v1alpha1.VirtualMachineList), nil
}
