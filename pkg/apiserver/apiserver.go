...
// New returns a new instance of HypervisorServer from the given config.
func (c completedConfig) New() (*HypervisorServer, error) {
	genericServer, err := c.GenericConfig.New("kube-qemu", genericapiserver.EmptyDelegate)
	if err != nil {
		return nil, err
	}
